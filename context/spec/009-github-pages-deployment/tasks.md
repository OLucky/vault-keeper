...
- [ ] **Slice 1: Vite base path and local build verification**
  ...
  - [ ] Run `npx vite preview` and verify the app loads at `http://localhost:4173/vault-keeper/`, table data loads, and navigation works. **[Agent: general-purpose]**

- [ ] **Slice 2: GitHub Actions deploy workflow and live deployment**
  ...
  - [ ] **Manual step (user):** In GitHub repo Settings > Pages, set source to "GitHub Actions" instead of "Deploy from a branch".
  - [ ] Push changes to `master` and verify the GitHub Actions workflow runs successfully. **[Agent: general-purpose]**
  - [ ] Verify the live site loads at `olucky.github.io/vault-keeper/` — app renders, table rolls work, navigation works, no 404s on assets. **[Agent: general-purpose]**
