    ...
    const tableSet: TableSet = {
      ...
      tables: [
        ...
        },
        {
          ...
          die: "d4",
          conditional: true,
          entries: [{ range: [1, 4], title: "Hidden Result" }],
        },
      ],
    };
    ...
    const fetchedTableSet: TableSet = {
      ...
      tables: [
        ...
        },
        {
          ...
          id: "mental",
          die: "d4",
          entries: [{ range: [1, 4], title: "Telepathy" }],
        },
      ],
    };
    ...
    const fetchedTableSet: TableSet = {
      ...
      tables: [
        ...
        },
        {
          ...
          die: "d4",
          conditional: true,
          entries: [{ range: [1, 4], title: "Should Be Skipped" }],
        },
      ],
    };
      ...
      tables: [
        {
          name: "Lookup",
          die: "d4",
          entries: [{ range: [1, 4], title: "Result" }],
        },
        {
          name: "Conditional",
          die: "d4",
          conditional: true,
          entries: [{ range: [1, 4], title: "Hidden" }],
        },
        {
          name: "Ego",
          type: "computed" as const,
