  ...
  return (
    <div className={styles.wrapper}>
      ...
      >
        {cells.map((cell) => {
          const { x, y } = hexCenter(cell.row, cell.col);
          const isMarker = cell.row === markerPosition.row && cell.col === markerPosition.col;
          const isStart = cell.row === START_HEX.row && cell.col === START_HEX.col;
          ...
          return (
            ...
            >
              ...
              />
              {isMarker && <circle cx={x} cy={y} r={4} fill="#39c5cf" opacity={0.8} />}
              <text
                x={x}
                y={isStart ? y - 4 : y}
                textAnchor="middle"
      ...
      <div className={styles.legend}>
        {Object.values(WeatherType).map((wt) => (
          <div key={wt} className={styles.legendItem}>
            <div className={styles.legendSwatch} style={{ backgroundColor: WEATHER_COLORS[wt] }} />
