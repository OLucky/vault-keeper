    ...
    <div className={styles.entry}>
      ...
      <div className={styles.actions}>
        <button
          ...
          onClick={() => isSaved ? setShowUnsaveConfirm(true) : useSavedResultsStore.getState().saveResult(entryAsResult, entry.categoryId)}
          type="button"
      ...
      {showUnsaveConfirm && (
        <ConfirmDialog
          ...
          onConfirm={() => { useSavedResultsStore.getState().removeResult(entry.id); setShowUnsaveConfirm(false) }}
